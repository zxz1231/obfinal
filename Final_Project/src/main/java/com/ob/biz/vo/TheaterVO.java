...
public class TheaterVO {
	...
	private String name, phone, adress, content, img1, img2, img3, img4, img5;
	...
	//파일 관련 필드 추가
		...
		public String toString() {
			return "TheaterVO [t_id=" + t_id + ", scr_num=" + scr_num + ", name=" + name + ", phone=" + phone
					+ ", adress=" + adress + ", content=" + content + ", img1=" + img1 + ", img2=" + img2 + ", img3="
					+ img3 + ", img4=" + img4 + ", img5=" + img5 + ", img1_file=" + img1_file + ", img2_file="
					+ img2_file + ", img3_file=" + img3_file + ", img4_file=" + img4_file + ", img5_file=" + img5_file
					+ "]";
		}
