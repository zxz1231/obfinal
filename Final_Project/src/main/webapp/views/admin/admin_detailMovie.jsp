					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="panel panel-white"
								style="border: red solid 1px; width: 150px; height: 100px">포스터
								넣는곳</div>
							<div class="panel panel-white"
								style="border: red solid 1px; width: 150px; height: 100px">스틸컷1</div>
							<div class="panel panel-white"
								style="border: red solid 1px; width: 150px; height: 100px">스틸컷2</div>
							<div class="panel panel-white"
								style="border: red solid 1px; width: 150px; height: 100px">스틸컷3</div>
							<div class="panel panel-white"
								style="border: red solid 1px; width: 150px; height: 100px">스틸컷4</div>
							<div class="panel panel-white"
								style="border: red solid 1px; width: 150px; height: 100px">스틸컷5</div>

						</div>
						<div class="col-md-4">
							<div class="panel panel-white" style="border: red solid 1px;">
								<label class="control-label">번호</label> <input id="title"
							...
							<div class="panel panel-white" style="border: red solid 1px;">제목:
								${movieOne.title}</div>
							<div class="panel panel-white" style="border: red solid 1px;">장르:
								${movieOne.gnr}</div>
							<div class="panel panel-white" style="border: red solid 1px;">감독</div>
							<div class="panel panel-white" style="border: red solid 1px;">상영시간</div>
							<div class="panel panel-white" style="border: red solid 1px;">현재상영중?</div>
							<div class="panel panel-white" style="border: red solid 1px;">투표수</div>
						...
						<div class="col-md-2">
							...
							<div class="panel panel-white" style="border: red solid 1px;">넘어온
								확인용 데이터 ${movieOne}</div>
						</div>
